...
$fecha = date(D.' '.j.' \d\e '.F.'\o'.' , '.Y);

// en arreglos hay hartas diferencias con JavaScript:

$arreglo = array("cerros","postres","música","viajar");

$arreglobjeto = array("apellidos"=>"Covarrubias Prieto","nombre"=>"Gracia","edad"=>"23", "signo"=>"Aries", "animal"=>"Oso Panda");
