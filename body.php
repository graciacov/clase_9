    ...
    <div class="container">
      <div class="row py-5">
        <div class="col">
          ...
          <ul>
          <!-- for($a=0 funcion inicial; hasta cuando quiero que haga eso; $a++ suma 1 al valor inicial, mientras el valor de al medio se compla) -->
          ...
          <p>
            Mi nombre es <?php print($arreglobjeto[nombre].' '.$arreglobjeto[apellidos]);?>,
          ...
          <p>
            Tengo información de los siguientes planetas de StarWars:
            <?php for ($a = 0; $a<count($csv); $a++){
               print('<li>'.$csv[$a][name].'</li>');
             }
            ?>
          </p>
